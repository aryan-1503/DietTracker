...
- Name: weekly-weight.spec.ts >> Weekly Weight Tracking Feature — Cycle 2 >> QA-5: After weight saved, reload app → popup does NOT reappear
- Location: test-cases\weekly-weight.spec.ts:148:7
