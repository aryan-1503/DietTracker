...
- Name: weekly-weight.spec.ts >> Weekly Weight Tracking Feature — Cycle 2 >> QA-11: Non-numeric input (abc) disables Save button
- Location: test-cases\weekly-weight.spec.ts:264:7
