...
- Name: weekly-weight.spec.ts >> Weekly Weight Tracking Feature — Cycle 2 >> QA-3: "Enter Later" dismisses popup; new navigation re-opens it if entry still missing
- Location: test-cases\weekly-weight.spec.ts:177:7
