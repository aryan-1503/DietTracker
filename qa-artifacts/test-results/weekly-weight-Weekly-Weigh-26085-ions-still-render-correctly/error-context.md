...
- Name: weekly-weight.spec.ts >> Weekly Weight Tracking Feature — Cycle 2 >> REGRESSION: Dashboard core sections still render correctly
- Location: test-cases\weekly-weight.spec.ts:542:7
