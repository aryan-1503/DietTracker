...
- Name: weekly-weight.spec.ts >> Weekly Weight Tracking Feature — Cycle 2 >> QA-7: JWT token expiry is 7 days (604800 seconds)
- Location: test-cases\weekly-weight.spec.ts:59:7

# Error details

```
Error: Login should succeed and return a token
