...
- Name: weekly-weight.spec.ts >> Weekly Weight Tracking Feature — Cycle 2 >> QA-16 (API): Decimal weight 72.3 kg is accepted and returned correctly
- Location: test-cases\weekly-weight.spec.ts:476:7
